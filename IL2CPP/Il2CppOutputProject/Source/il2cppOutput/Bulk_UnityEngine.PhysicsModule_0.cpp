...
{
	{
		...
		RaycastHit_INTERNAL_CALL_CalculateRaycastTexCoord_m2536838559(NULL /*static, unused*/, (Vector2_t2156229523 *)L_0, L_1, (Vector2_t2156229523 *)(&___uv2), (Vector3_t3722313464 *)(&___point3), L_2, L_3, /*hidden argument*/NULL);
		return;
	}
}
// System.Void UnityEngine.RaycastHit::INTERNAL_CALL_CalculateRaycastTexCoord(UnityEngine.Vector2&,UnityEngine.Collider,UnityEngine.Vector2&,UnityEngine.Vector3&,System.Int32,System.Int32)
...
extern "C"  Vector2_t2156229523  RaycastHit_get_textureCoord_m3787807740 (RaycastHit_t1056001966 * __this, const RuntimeMethod* method)
{
	...
	memset(&V_1, 0, sizeof(V_1));
	{
		...
		RaycastHit_CalculateRaycastTexCoord_m1747810766(NULL /*static, unused*/, (Vector2_t2156229523 *)(&V_0), L_0, L_1, L_2, L_3, 0, /*hidden argument*/NULL);
...
extern "C"  Vector2_t2156229523  RaycastHit_get_textureCoord2_m924018133 (RaycastHit_t1056001966 * __this, const RuntimeMethod* method)
{
	...
	memset(&V_1, 0, sizeof(V_1));
	{
		...
		Vector3_t3722313464  L_2 = __this->get_m_Point_0();
		int32_t L_3 = __this->get_m_FaceID_2();
		RaycastHit_CalculateRaycastTexCoord_m1747810766(NULL /*static, unused*/, (Vector2_t2156229523 *)(&V_0), L_0, L_1, L_2, L_3, 1, /*hidden argument*/NULL);
		Vector2_t2156229523  L_4 = V_0;
		V_1 = L_4;
		goto IL_0028;
	}
...
extern "C"  Vector2_t2156229523  RaycastHit_get_lightmapCoord_m3586439682 (RaycastHit_t1056001966 * __this, const RuntimeMethod* method)
{
	...
	memset(&V_2, 0, sizeof(V_2));
	{
		...
		int32_t L_3 = __this->get_m_FaceID_2();
		RaycastHit_CalculateRaycastTexCoord_m1747810766(NULL /*static, unused*/, (Vector2_t2156229523 *)(&V_0), L_0, L_1, L_2, L_3, 1, /*hidden argument*/NULL);
		Collider_t1773347010 * L_4 = RaycastHit_get_collider_m1464180279((RaycastHit_t1056001966 *)__this, /*hidden argument*/NULL);
		NullCheck(L_4);
